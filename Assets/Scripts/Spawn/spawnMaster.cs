...
public class spawnMaster : MonoBehaviour 
{
	...
	private IEnumerator PatOne()
	{
		...
		SpawnFood (Random.Range (0, foodObj.Length), 1);
	...
	private IEnumerator PatTwo()
	{
		...
		yield return new WaitForSeconds(timeBetweenSpawns);
		SpawnFood (Random.Range (0, foodObj.Length), 2);
	...
	private IEnumerator PatThree()
	{
		...
		yield return new WaitForSeconds(timeBetweenSpawns);
		SpawnFood (Random.Range (0, foodObj.Length), 3);
	...
	private void SpawnFood(int sprite, int lane )
	{
		...
		clone.rigidbody2D.AddForce (new Vector2(0, -dropSpeed));
	}
